...
class page3TableViewController: UITableViewController {
    ...
    struct PropertyKeys {
            static let page3Cell = "page3Cell"
        }
    ...
    func fetchDrinkData() {
        ...
        let url = URL(string: "https://api.airtable.com/v0/appvq2U3XqCHAteXi/Page3")!
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: PropertyKeys.page3Cell, for: indexPath) as! page3TableViewCell

        let drink = drinkData?.records[indexPath.row]
        
        cell.drinkName3Label.text = drink?.fields.name
        cell.describe3Label.text = drink?.fields.describe ?? " "
        cell.medium3Label.text = "\((drink?.fields.mediumPrice)!)"
        cell.large3Label.text = "\((drink?.fields.largePrice)!)"
